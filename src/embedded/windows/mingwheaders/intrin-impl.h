...
#ifndef THIS_SUCKS_DD
#define THIS_SUCKS_DD
inline __int64 _InterlockedAnd64(volatile __int64 *Destination, __int64 Value) {
...
#ifndef THIS_SUCKS_EE
#define THIS_SUCKS_EE
inline __int64 _InterlockedOr64(volatile __int64 *Destination, __int64 Value) {
...
#ifndef THIS_SUCKS_FF
#define THIS_SUCKS_FF
inline __int64 _InterlockedXor64(volatile __int64 *Destination, __int64 Value) {
...
#ifndef THIS_SUCKS_AA
#define THIS_SUCKS_AA
__LONG32 _InterlockedAnd(__LONG32 volatile *, __LONG32);
/*inline __LONG32 _InterlockedAnd(volatile __LONG32 *Destination, __LONG32 Value) {
    return __sync_fetch_and_and(Destination, Value);
}*/
#endif
...
#ifndef THIS_SUCKS_BB
#define THIS_SUCKS_BB
__LONG32 _InterlockedOr(__LONG32 volatile *, __LONG32);
/*inline __LONG32 _InterlockedOr(volatile __LONG32 *Destination, __LONG32 Value) {
    return __sync_fetch_and_or(Destination, Value);
}*/
#endif
...
#ifndef THIS_SUCKS_CC
#define THIS_SUCKS_CC
__LONG32 _InterlockedXor(__LONG32 volatile *, __LONG32);
/*inline __LONG32 _InterlockedXor(volatile __LONG32 *Destination, __LONG32 Value) {
    return __sync_fetch_and_xor(Destination, Value);
}*/
#endif
