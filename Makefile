...
$(OBJDIR)/embedded/converters.o \
$(OBJDIR)/embedded/checknulls.o \
$(OBJDIR)/embedded/embedded.o \
$(OBJDIR)/embedded/javaids.o \
$(OBJDIR)/embedded/jresultset.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_env_MonetDBEmbeddedConnection.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_env_MonetDBEmbeddedDatabase.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_env_MonetDBEmbeddedPreparedStatement.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_jdbc_EmbeddedDataBlockResponse.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_jdbc_JDBCEmbeddedConnection.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_mapping_NullMappings.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_resultset_QueryResultSet.o \
$(OBJDIR)/embedded/nl_cwi_monetdb_embedded_tables_MonetDBTable.o \
